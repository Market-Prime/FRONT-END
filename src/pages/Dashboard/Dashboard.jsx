...
const Dashboard = () => {
  ...
  const bestproducts = [
    {image:"/images/Rectangle 4024.png", name:"Women Classy Fashion Bag", price:"#50,000"},
    {image:"/images/Rectangle 4038.png", name:"Women Classy Top", price:"#20,000"},
    {image:"/images/Rectangle 4035.png",name:"Men Classy Leather Watch", price:"#150,000"},
    {image:"/images/Rectangle 4033.png", name:"Men Classy Set", price:'#100,000'},
    {image:"/images/Rectangle 4025.png", name:"Women Bodycon Dress", price:"#30,000"}
  ]
      ...
      <div className="flex justify-between h-full w-full relative">
        ...
        <Header />
          ...
          <div className="w-[24%] bg-white rounded-xl">
            <h3 className="text-start mt-2 pl-10 pb-2 text-xl">Order Status</h3>
            ...
            <div className="flex items-center justify-between my-5 w-4/5 mx-auto">
              <div className="">
                ...
                <span className="text-center text-base block text-[#3D56FA]">79%</span>
              </div>
              <div className="">
                <p className="h-7 bg-[#F7EC1B] w-8 text-center mx-auto"></p>
                <p className="text-center text-sm">Pending</p>
                <span className="text-center text-base block text-[#F7EC1B]">12%</span>
              </div>
              <div className="">
                <p className="h-7 bg-[#F82A0D] w-8 text-center mx-auto"></p>
                <p className="text-center text-sm">Canceled</p>
                <span className="text-center text-base block text-[#F82A0D]">9%</span>
              </div>
            </div>
          </div>
            ...
            <ResponsiveContainer width="100%" height={400} className="mt-12">
              ...
              <Bar dataKey="sales" fill="#227BF2" background={{ fill: '#eee' }} />
              </BarChart>
            </ResponsiveContainer>
            </div>
          ...
          <div className="h-[34%] flex justify-around items-center min-w-full mt-2">
            ...
            <div className="w-[23%] h-full border-2 rounded-md bg-white px-5 py-5">
              ...
              <div className="flex items-center justify-between mt-2">
                <p className="text-sm">Overall rate of 200 customer’s reviews.</p>
