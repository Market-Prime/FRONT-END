  ...
  return (
    <div>
      ...
      <div className='2xl:w-1/3 xl:w-1/3 lg:w-1/2 md:w-1/2 sm:w-full bg-white rounded-3xl shadow-2xl m-auto my-56 py-10'>
        ...
        className="2xl:w-1/3 xl:w-1/3 lg:w-1/2 md:w-1/2 sm:w-1/2 mx-auto bg-aboutbg block py-3 rounded-lg text-white uppercase text-center font-bold mt-10">Confirm Account</Link>
      </div>
    </div>
  );
}
