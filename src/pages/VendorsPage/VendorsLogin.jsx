  ...
  const handleLogin = async (e) => {
    ...
    try {
      const response = await axios.post(
        "https://backend-server-0ddt.onrender.com/api/account/vendor/login",
        { email, password }
      );
                ...
                {showPassword ? (
                  ...
                  >
                    <path
                      ...
                      strokeLinejoin="round"
                      strokeWidth={2}
                      d="M9.988 5.688L5 9.676M5 9.676l-.207-.2c-2.11-2.12-2.112-5.543 0-7.665a5.5 5.5 0 017.778-.293M5 9.676l8.485 8.486M17.453 17.454a5.5 5.5 0 010 7.778l-2.707 2.707m3.415-10.607l-6.364-6.365"
                    />
                  </svg>
                )}
              </span>
