  ...
  const topdeal = Topdealdata.map((item, i) =>{
    return(
      <div className="mx-auto  mb-8" key={i}>
        ...
        <span className="text-base text-topdeal font-bold ml-5">{item.price}</span>
        <div className="flex items-center justify-start w-full ml-5 mx-auto">
          <Link to={item.link} className="bg-seamlessbg py-2 text-white font-bold w-7/12 text-start px-2 rounded-xl">{item.button}</Link>
  ...
  return(
    <div>
      ...
      <div className="flex items-center justify-between w-full bg-seamlessbg px-52 py-2">
        <div>
          <p className="text-4xl text-white text-center">Discover seamless Fashion <br/>shopping experience</p>
          <Link to="Shop" className="block mt-10 bg-white  py-6 mx-auto font-bold w-2/3 text-center rounded-3xl text-4xl text-shopcolor">Shop now</Link>
        </div>
        <div>
      ...
      <div className="px-5">
        <div className="bg-topdealbg px-5 py-5 mt-5">
          <p className="text-topdeal text-4xl font-semibold">Today's Top Deal</p>
      ...
      <div className="bg-seamlessbg px-5 py-5 flex items-center justify-between w-full">
        <div className="w-1/5">
          <p className="text-white text-5xl w-full leading-snug">Get your perfect fit by using our Virtual Try-On</p>
        </div>
        ...
        <div className="w-1/5 bg-gradient-to-b from-white to-tryonecolor py-6 rounded-2xl">
          <p className="text-4xl text-center font-extrabold text-shopcolor">Check our <br />Virtual Try-On</p>
        </div>
      </div>
      {/* End of Perfect Fit */}
      ...
      <div className="bg-seamlessbg pt-10 px-32 flex items-center justify-between w-full">
        <div>
          <p className="text-4xl text-white text-start leading-snug font-extrabold">Never wear a <br />boring outfit</p>
          <p className="mt-10 text-white text-2xl">Shop with Market Prime for an outfit that fits.</p>
          <Link to="Shop" className="block mt-10 bg-white  py-6 mx-0 font-bold w-2/3 text-center rounded-3xl text-4xl text-shopcolor">Shop now</Link>
        </div>
        <div>
