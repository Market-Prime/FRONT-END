...
const Hero = () =>{
    return(
        <div className="bg-herocolor px-10 py-10 xl:h-screen lg:h-screen md:h-screen sm:h-screen 2xl:h-screen  hero-section w-full">
            <h1 className="font-bold lg:text-7xl md:text-5xl sm:text-4xl xl:text-7xl uppercase  text-white w-full xl:tracking-[.65em] lg:tracking-[.40em] sm:tracking-[.15em] md:tracking-[.32em] sm:mt-20 md:mt-32 lg:mt-10 xl:mt-10">market prime</h1>
            <div className="mt-10">
