...
const Footer = () =>{
    return(
        <div className="mt-5 flex sm:flex-col md:flex-row lg:flex-row xl:flex-row 2xl:flex-row items-start justify-center w-full bg-topdealbg py-20 sm:py-10 md:px-10 xl:px-32 2xl:px-32 sm:px-10 mx-auto">
