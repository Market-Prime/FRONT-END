        ...
        <div className="flex items-start justify-between 2xl:mt-5 xl:mt-5 lg:mt-10  w-full">
          ...
          <div className="xl:pl-10 lg:pl-10 flex items-center justify-start w-1/2">
            ...
            <div className="pl-10 xl:pl-2">
              <p className="xl:w-full lg:w-full xl:text-2xl text-3xl font-extralight">
                Lady's sweat <br />
                top
              </p>
              <p className="uppercase mt-10 font-bold">
                color: <span className="lowercase font-extralight">blue</span>
              </p>
          ...
          <div className="flex flex-col w-1/2 items-end justify-center mt-0">
            <div className="bg-cartbg w-2/5 rounded-lg">
              ...
              <h5 className="text-center text-white text-3xl font-medium">
                My Look
              </h5>
              <img
                src="/images/Rectangle 367.png"
                className="px-12 my-10 mx-auto"
              />
              <button className="w-1/2 text-white text-center block bg-cartcolor py-2 rounded-xl text-2xl mx-auto mb-2">
                Add to cart
              </button>
            </div>
          </div>
