...
const Accountmanagement = () => {
  ...
  const saveChanges = async () => {
    ...
    try {
      ...
      toast.error(
        errorMessage || "Failed to update fields, please try again later",
        {
          position: "top-right",
          autoClose: 5000,
          hideProgressBar: true,
    ...
    <div className="flex flex-col md:flex-row items-start justify-start  w-full h-screen">
      ...
      >
        <ul className="space-y-4">
          ...
          <li>
            <a href="#" className="text-white my-12 block text-xl">
              Account details
            </a>
          </li>
          <li>
          ...
          <form className="space-y-4">
            ...
            <div className="flex items-center">
              ...
              <input
                ...
                className={`border w-2/3 px-2 py-1 rounded ${
                  editMode.first_name ? "bg-white" : "bg-gray-100"
                }`}
              />
              <button
                type="button"
            ...
            <div className="flex items-center">
              ...
              <input
                ...
                className={`border w-2/3 px-2 py-1 rounded ${
                  editMode.last_name ? "bg-white" : "bg-gray-100"
                }`}
              />
            ...
            <div className="flex items-center">
              ...
              <input
                ...
                className={`border w-2/3 px-2 py-1 rounded ${
                  editMode.phone_number ? "bg-white" : "bg-gray-100"
                }`}
              />
              <button
                type="button"
            ...
            <div className="flex items-center">
              ...
              <input
                ...
                className={`border w-2/3 px-2 py-1 rounded ${
                  editMode.rewardCode ? "bg-white" : "bg-gray-100"
                }`}
              />
              <button
                type="button"
                onClick={() => toggleEditMode("rewardCode")}
              >
                <FaPencilAlt className="ml-2 text-gray-500" />
              </button>
            </div>
