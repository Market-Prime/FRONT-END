...
const About = () =>{
    return (
        <div className="bg-aboutbg py-20 xl:px-40 lg:px-28 md:px-20 sm:px-10">
            <h1 className="text-white xl:text-8xl lg:text-6xl md:text-6xl sm:text-4xl font-bold text-start tracking-widest">About Market Prime</h1>
            <p className="mt-10 font-normal text-xl text-white">Market Prime is a cutting-edge fashion e-commerce platform dedicated to bringing the latest trends and high-quality fashion items to our customers. 
